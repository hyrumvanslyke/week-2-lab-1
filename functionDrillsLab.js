...
console.log(exclaimThree('hello shawty'))
...
function checkName(x){
  if(x === 'Steven'){
    ...
    console.log(`Cool name, ${x}`)
  }
}
let nameGreeting = checkName('Billy Bob Joe')
...
//CODE HERE
let bestMovie = x => `${x} is the best movie ever!`
console.log(bestMovie('Spiderman No Way Home'))
...
let whoIsLeft = theEliminator(contestants, loser)
...
console.log(emailCheck(' hyrumevanslyke@gmail.com  '))
////////////////// PROBLEM 19 ////////////////////
/*
...
//CODE HERE
function goldToFrogs(x){
  return x/3
}
let totalFrogs = goldToFrogs(21)
console.log(`With the gold I have I can buy ${totalFrogs} chocolate frogs in total`)
////////////////// PROBLEM 20 ////////////////////
/*
...
//CODE HERE
function goldToFrogs2(x){
  let deciaml = x/3
  return Math.floor(deciaml)
}
let totalFrogs2 = goldToFrogs2(4)
console.log(`With the gold I have I can buy ${totalFrogs2} chocolate frogs in total`)
////////////////// PROBLEM 21 ////////////////////
